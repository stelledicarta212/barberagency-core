if (!process.argv.includes('--override-guardrail')) {
  console.error('FAIL-CLOSED GUARDRAIL: update_login_workflow.js contains obsolete SQL logic (email_contacto). Execution blocked. Pass --override-guardrail to bypass.');
  process.exit(1);
}
