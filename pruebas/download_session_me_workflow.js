...
const WORKFLOW_ID = 'iUZCTRli7ghGFrEb'; // BarberAgency - Session Me v2
...
const req = https.request(options, res => {
  ...
  res.on('end', () => {
    try {
      ...
      fs.writeFileSync(path.join(__dirname, 'session_me_workflow.json'), JSON.stringify(parsed, null, 2));
      console.log('Saved session_me workflow definition successfully!');
    } catch (e) {
